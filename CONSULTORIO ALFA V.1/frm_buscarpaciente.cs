...
namespace CONSULTORIO_ALFA_V._1
{
    public partial class frm_buscarpaciente : Form
    {
        ...
        private void txtBuscar_KeyPress(object sender, KeyPressEventArgs e)
        {
            try
            {
                string consulta = "SELECT historiaclinica.idHistoriaClinica as HistoriaClinica, paciente.Cedula as Cedula, paciente.Apellidos, paciente.Nombres FROM historiaclinica INNER JOIN paciente ON historiaclinica.Paciente_Cedula = paciente.Cedula ";
            ...
            try
            {
                if (e.RowIndex != dataGridView1.Rows.Count - 1)
                {
                    ...
                    for (int i = 0; i < dataGridView1.ColumnCount; i++)
                    {
                        ...
                        cedula = dataGridView1[1, e.RowIndex].Value.ToString();
